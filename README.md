...
| `FMD_NOTIFY_CASE_DELIVERY_EMAIL_ADDRESS`            | String  | an email that is in notify guest list                                                                 | Email address for Foot and Mouth Disease case delivery notifications |
| `FMD_NOTIFY_APPLICANT_CONFIRMATION_TEMPLATE_ID`     | String  | 2327b94a-262a-4b91-8e93-821104c6c8e5                                                                  | Template ID for Foot and Mouth Disease applicant confirmation emails |
| `FMD_NOTIFY_CASE_DELIVERY_TEMPLATE_ID`              | String  | 9451ae1d-0609-4d49-a490-a5efecb8b013                                                                  | Template ID for Foot and Mouth Disease case delivery emails          |
